...
import { A, Route, Router, useNavigate, type RouteSectionProps } from '@solidjs/router';
      ...
      <header class="border-b sticky top-0 z-10 bg-white/70 dark:bg-neutral-900/70 backdrop-blur">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center gap-4 h-14">
          ...
          <nav class="flex items-center gap-3 text-sm">
            <A href="/" end activeClass="text-brand-600" class="hover:underline">Servers</A>
            <A href="/launch" activeClass="text-brand-600" class="hover:underline">Launch</A>
          </nav>
          <div class="ml-auto">
            <input id="global-search" placeholder="Search… (/ to focus)" class="w-64 rounded-md border px-3 py-2 bg-white dark:bg-neutral-900" />
          </div>
        </div>
      </header>
